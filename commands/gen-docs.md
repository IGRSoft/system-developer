...
- `company-workflow:code-comment-standard` — the WHY/contract-only standard every comment written here must satisfy (no restated code, no history/provenance, no call-site enumeration).
