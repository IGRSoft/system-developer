...
> Rationale and before/after notes belong in the PR or `.context/development-N.md`, NOT in source comments (`igrsoft:code-comment-standard`) — source comments carry only the non-obvious WHY and the contract.
