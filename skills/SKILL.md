...
| **workflow-integration** | [_shared/workflow-integration/SKILL.md](_shared/workflow-integration/SKILL.md) | Integrating with the company-workflow 11-stage workflow system (v4.0.0) |
