...
| File | Description |
|------|-------------|
| `workflow-integration/SKILL.md` | Guide for integrating with igrsoft 11-stage workflow system (v3.27.1) — DV/DR/QA contracts, screenshot cli-fallback, gate feedback |
