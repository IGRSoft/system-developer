...
| File | Description |
|------|-------------|
| `workflow-integration/SKILL.md` | Guide for integrating with company-workflow 11-stage workflow system (v4.0.0) — DV/DR/QA contracts, screenshot cli-fallback, gate feedback |
