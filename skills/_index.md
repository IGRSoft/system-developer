...
| **workflow-integration** | [`_shared/workflow-integration/SKILL.md`](_shared/workflow-integration/SKILL.md) | Guide for integrating with the company-workflow 11-stage workflow system (v4.0.0) |
